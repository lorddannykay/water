...
/** Stored in DB as English `value`; shown bilingually in the UI. */
...
export function formatSiteTypeLabel(option: SiteTypeOption): string {
  return `${option.labelTa} · ${option.labelEn}`;
}
